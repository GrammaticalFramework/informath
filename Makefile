...
next/grammars/NextInformath.pgf: $(GF_FILES)
	cd next/grammars ; gf --make -output-format=haskell -haskell=lexical --haskell=gadt -lexical=Name,Noun,Noun1,Noun2,Fam,Fam2,Adj,Adj2,Adj3,AdjC,AdjE,Fun,Fun2,FunC,Verb,Verb2,Label,Compar,Const,Oper,Oper2 -name=NextInformath InformathEng.gf InformathSwe.gf InformathFre.gf
