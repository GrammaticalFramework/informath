...
next_grammar:
	cd grammars ; gf --make --probs=Informath.probs InformathEng.gf InformathSwe.gf InformathFre.gf InformathFin.gf InformathCze.gf ; mv Informath.pgf ../share/InformathFull.pgf
