...
import PreviousInformath -- superset of Core
...
informathPrefix = "PreviousInformath"
informathPGFFile = "previous/grammars/" ++ informathPrefix ++ ".pgf"
baseConstantDataFile = "previous/base_constant_data.dkgf"
