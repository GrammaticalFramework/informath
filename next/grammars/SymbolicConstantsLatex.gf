...
lin
  ...
  plus_Oper2 = mkOper2 "\\implus" <1 : Prec> <1 : Prec> <2 : Prec> ;
  minus_Oper2 = mkOper2 "\\imminus" <1 : Prec> <1 : Prec> <2 : Prec> ;
  times_Oper2 = mkOper2 "\\imtimes"  <2 : Prec> <2 : Prec> <3 : Prec> ;
  div_Oper2 = mkOper2 "\\imdiv{" "} {" "}" <3 : Prec> <0 : Prec> <0 : Prec> ;
  pow_Oper2 = mkOper2 "\\impow" <3 : Prec> <4 : Prec> <2 : Prec> ;
  neg_Oper = prefixOper "\\imneg" <1 : Prec> <2 : Prec> ;
