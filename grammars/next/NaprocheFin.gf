concrete NaprocheFin of Naproche = CategoriesFin, TermsLatex **
...
lin
  ...
  NoCommaAllProp argkinds prop =
    simpleProp (lin S {s = (SyntaxFin.mkAdv for_Prep (mkNP all_Predet argkinds.pl)).s ++ (partProp prop).s}) ;
