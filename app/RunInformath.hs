...
helpMsg4 = unlines [
  ...
  "",
  just "-synonyms=<int>" "the maximum number of verbal constant synonyms considered",
  just "-symbolics=<int>" "the maximum number of symbolic constant synonyms considered",
