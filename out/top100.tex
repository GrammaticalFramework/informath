...
%% (Scores {tree_length = 48, tree_depth = 9, characters = 78, tokens = 36, subsequent_dollars = 0, initial_dollars = 0, parses = 1},172)

Thm01. Let $m , n \in N$. Then if $n \neq 0$, then $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 50, tree_depth = 10, characters = 79, tokens = 38, subsequent_dollars = 0, initial_dollars = 0, parses = 1},178)

Thm01. Let $m , n \in N$. Then $n \neq 0$, only if $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 50, tree_depth = 10, characters = 79, tokens = 38, subsequent_dollars = 0, initial_dollars = 0, parses = 1},178)

Thm01. Let $m , n \in N$. Assume that $n \neq 0$. Then $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 51, tree_depth = 10, characters = 83, tokens = 38, subsequent_dollars = 0, initial_dollars = 0, parses = 1},183)

Thm01. If $n \neq 0$, then $(\frac{ m}{n})^ {2}\neq 2$ for all natural numbers $m$ and $n$.
%% (Scores {tree_length = 47, tree_depth = 11, characters = 91, tokens = 39, subsequent_dollars = 0, initial_dollars = 0, parses = 1},189)

Thm01. Let $m$ and $n$ be natural numbers. Then $n \neq 0$ implies $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 45, tree_depth = 9, characters = 95, tokens = 39, subsequent_dollars = 0, initial_dollars = 0, parses = 1},189)

Thm01. For all natural numbers $m$ and $n$, if $n \neq 0$, then $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 48, tree_depth = 11, characters = 92, tokens = 40, subsequent_dollars = 0, initial_dollars = 0, parses = 1},192)

Thm01. Let $m$ and $n$ be natural numbers. Then if $n \neq 0$, then $(\frac{ m}{n})^ {2}\neq 2$.
%% (Scores {tree_length = 47, tree_depth = 10, characters = 96, tokens = 41, subsequent_dollars = 0, initial_dollars = 0, parses = 1},195)
...
%% (Scores {tree_length = 43, tree_depth = 10, characters = 64, tokens = 32, subsequent_dollars = 0, initial_dollars = 0, parses = 1},150)

Thm01a. $(\frac{ m}{n + 1})^ {2}\neq 2$ for all natural numbers $m$ and $n$.
%% (Scores {tree_length = 40, tree_depth = 11, characters = 76, tokens = 33, subsequent_dollars = 0, initial_dollars = 1, parses = 1},162)

Thm01a. For all natural numbers $m$ and $n$, $(\frac{ m}{n + 1})^ {2}\neq 2$.
%% (Scores {tree_length = 41, tree_depth = 11, characters = 77, tokens = 34, subsequent_dollars = 1, initial_dollars = 0, parses = 1},165)
...
%% (Scores {tree_length = 29, tree_depth = 8, characters = 44, tokens = 20, subsequent_dollars = 0, initial_dollars = 0, parses = 1},102)

Thm01b. $q ^ {2}\neq 2$ for every rational number $q$.
%% (Scores {tree_length = 26, tree_depth = 9, characters = 54, tokens = 19, subsequent_dollars = 0, initial_dollars = 1, parses = 1},110)

Thm01b. $q ^ {2}\neq 2$ for all rational numbers $q$.
%% (Scores {tree_length = 27, tree_depth = 9, characters = 53, tokens = 19, subsequent_dollars = 0, initial_dollars = 1, parses = 1},110)

Thm01b. For all rational numbers $q$, $q ^ {2}\neq 2$.
%% (Scores {tree_length = 28, tree_depth = 9, characters = 54, tokens = 20, subsequent_dollars = 1, initial_dollars = 0, parses = 1},113)
...
%% (Scores {tree_length = 26, tree_depth = 8, characters = 46, tokens = 19, subsequent_dollars = 0, initial_dollars = 0, parses = 1},100)

Thm01c. $\sqrt{ 2}\neq q$ for every rational number $q$.
%% (Scores {tree_length = 23, tree_depth = 9, characters = 56, tokens = 18, subsequent_dollars = 0, initial_dollars = 1, parses = 1},108)

Thm01c. $\sqrt{ 2}\neq q$ for all rational numbers $q$.
%% (Scores {tree_length = 24, tree_depth = 9, characters = 55, tokens = 18, subsequent_dollars = 0, initial_dollars = 1, parses = 1},108)

Thm01c. For all rational numbers $q$, $\sqrt{ 2}\neq q$.
%% (Scores {tree_length = 25, tree_depth = 9, characters = 56, tokens = 19, subsequent_dollars = 1, initial_dollars = 0, parses = 1},111)
...
%% (Scores {tree_length = 59, tree_depth = 13, characters = 109, tokens = 47, subsequent_dollars = 0, initial_dollars = 0, parses = 1},229)

Thm04. Let $u$ and $v$ be vectors. Then $u \perp v$ implies $\| u + v \| = \sqrt{ \| u \| ^{ 2}+ \| v \| ^{ 2}}$.
%% (Scores {tree_length = 57, tree_depth = 11, characters = 113, tokens = 47, subsequent_dollars = 0, initial_dollars = 0, parses = 1},229)

Thm04. For all vectors $u$ and $v$, if $u \perp v$, then $\| u + v \| = \sqrt{ \| u \| ^{ 2}+ \| v \| ^{ 2}}$.
%% (Scores {tree_length = 60, tree_depth = 13, characters = 110, tokens = 48, subsequent_dollars = 0, initial_dollars = 0, parses = 1},232)

Thm04. Let $u$ and $v$ be vectors. Then if $u \perp v$, then $\| u + v \| = \sqrt{ \| u \| ^{ 2}+ \| v \| ^{ 2}}$.
%% (Scores {tree_length = 59, tree_depth = 12, characters = 114, tokens = 49, subsequent_dollars = 0, initial_dollars = 0, parses = 1},235)
...
%% (Scores {tree_length = 87, tree_depth = 12, characters = 174, tokens = 77, subsequent_dollars = 0, initial_dollars = 0, parses = 1},351)
...
%% (Scores {tree_length = 88, tree_depth = 11, characters = 178, tokens = 77, subsequent_dollars = 0, initial_dollars = 0, parses = 1},355)
...
%% (Scores {tree_length = 84, tree_depth = 13, characters = 186, tokens = 78, subsequent_dollars = 0, initial_dollars = 0, parses = 1},362)
...
%% (Scores {tree_length = 85, tree_depth = 13, characters = 187, tokens = 79, subsequent_dollars = 0, initial_dollars = 0, parses = 1},365)
...
%% (Scores {tree_length = 84, tree_depth = 12, characters = 191, tokens = 80, subsequent_dollars = 0, initial_dollars = 0, parses = 1},368)
...
%% (Scores {tree_length = 76, tree_depth = 13, characters = 158, tokens = 59, subsequent_dollars = 0, initial_dollars = 0, parses = 1},307)
...
%% (Scores {tree_length = 74, tree_depth = 13, characters = 172, tokens = 61, subsequent_dollars = 0, initial_dollars = 0, parses = 1},321)
...
%% (Scores {tree_length = 77, tree_depth = 13, characters = 172, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},325)
...
%% (Scores {tree_length = 84, tree_depth = 14, characters = 169, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},334)
...
%% (Scores {tree_length = 85, tree_depth = 14, characters = 172, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},338)
...
%% (Scores {tree_length = 86, tree_depth = 14, characters = 175, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},342)
...
%% (Scores {tree_length = 82, tree_depth = 14, characters = 183, tokens = 68, subsequent_dollars = 0, initial_dollars = 0, parses = 1},348)
...
%% (Scores {tree_length = 83, tree_depth = 14, characters = 186, tokens = 68, subsequent_dollars = 0, initial_dollars = 0, parses = 1},352)
...
%% (Scores {tree_length = 84, tree_depth = 14, characters = 189, tokens = 68, subsequent_dollars = 0, initial_dollars = 0, parses = 1},356)
...
%% (Scores {tree_length = 86, tree_depth = 14, characters = 189, tokens = 70, subsequent_dollars = 0, initial_dollars = 0, parses = 1},360)
...
%% (Scores {tree_length = 80, tree_depth = 14, characters = 197, tokens = 70, subsequent_dollars = 0, initial_dollars = 0, parses = 1},362)
...
%% (Scores {tree_length = 87, tree_depth = 14, characters = 192, tokens = 70, subsequent_dollars = 0, initial_dollars = 0, parses = 1},364)
...
%% (Scores {tree_length = 81, tree_depth = 14, characters = 200, tokens = 70, subsequent_dollars = 0, initial_dollars = 0, parses = 1},366)
...
%% (Scores {tree_length = 82, tree_depth = 14, characters = 203, tokens = 70, subsequent_dollars = 0, initial_dollars = 0, parses = 1},370)
...
%% (Scores {tree_length = 84, tree_depth = 14, characters = 203, tokens = 72, subsequent_dollars = 0, initial_dollars = 0, parses = 1},374)
...
%% (Scores {tree_length = 85, tree_depth = 14, characters = 206, tokens = 72, subsequent_dollars = 0, initial_dollars = 0, parses = 1},378)
...
%% (Scores {tree_length = 88, tree_depth = 14, characters = 209, tokens = 74, subsequent_dollars = 0, initial_dollars = 0, parses = 1},386)
...
%% (Scores {tree_length = 82, tree_depth = 14, characters = 217, tokens = 74, subsequent_dollars = 0, initial_dollars = 0, parses = 1},388)
...
%% (Scores {tree_length = 83, tree_depth = 14, characters = 220, tokens = 74, subsequent_dollars = 0, initial_dollars = 0, parses = 1},392)
...
%% (Scores {tree_length = 86, tree_depth = 14, characters = 223, tokens = 76, subsequent_dollars = 0, initial_dollars = 0, parses = 1},400)
...
%% (Scores {tree_length = 58, tree_depth = 10, characters = 152, tokens = 53, subsequent_dollars = 0, initial_dollars = 0, parses = 1},274)
...
%% (Scores {tree_length = 66, tree_depth = 11, characters = 163, tokens = 60, subsequent_dollars = 0, initial_dollars = 0, parses = 1},301)
...
%% (Scores {tree_length = 67, tree_depth = 11, characters = 166, tokens = 60, subsequent_dollars = 0, initial_dollars = 0, parses = 1},305)
...
%% (Scores {tree_length = 68, tree_depth = 11, characters = 169, tokens = 60, subsequent_dollars = 0, initial_dollars = 0, parses = 1},309)
...
%% (Scores {tree_length = 64, tree_depth = 11, characters = 177, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},315)
...
%% (Scores {tree_length = 65, tree_depth = 11, characters = 180, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},319)
...
%% (Scores {tree_length = 66, tree_depth = 11, characters = 183, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},323)
...
%% (Scores {tree_length = 68, tree_depth = 11, characters = 183, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},327)
...
%% (Scores {tree_length = 69, tree_depth = 11, characters = 186, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},331)
...
%% (Scores {tree_length = 66, tree_depth = 11, characters = 197, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},341)
...
%% (Scores {tree_length = 67, tree_depth = 11, characters = 200, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},345)
...
%% (Scores {tree_length = 70, tree_depth = 11, characters = 203, tokens = 68, subsequent_dollars = 0, initial_dollars = 0, parses = 1},353)
...
%% (Scores {tree_length = 39, tree_depth = 9, characters = 94, tokens = 36, subsequent_dollars = 0, initial_dollars = 0, parses = 1},179)

Thm51wilson. $n$ is prime, if and only if $(n - 1)! \equiv - 1 \pmod{ n}$ for every natural number $n$.
%% (Scores {tree_length = 36, tree_depth = 10, characters = 103, tokens = 35, subsequent_dollars = 0, initial_dollars = 1, parses = 1},186)

Thm51wilson. $n$ is prime, if and only if $(n - 1)! \equiv - 1 \pmod{ n}$ for all natural numbers $n$.
%% (Scores {tree_length = 37, tree_depth = 10, characters = 102, tokens = 35, subsequent_dollars = 0, initial_dollars = 1, parses = 1},186)

Thm51wilson. For all natural numbers $n$, $n$ is prime, if and only if $(n - 1)! \equiv - 1 \pmod{ n}$.
%% (Scores {tree_length = 38, tree_depth = 10, characters = 103, tokens = 36, subsequent_dollars = 1, initial_dollars = 0, parses = 1},189)
...
%% (Scores {tree_length = 36, tree_depth = 10, characters = 62, tokens = 27, subsequent_dollars = 0, initial_dollars = 0, parses = 1},136)

Thm52. $A$ is a finite set, only if $| \wp A | = 2 ^ {| A |}$.
%% (Scores {tree_length = 36, tree_depth = 10, characters = 62, tokens = 27, subsequent_dollars = 0, initial_dollars = 1, parses = 1},137)
...
%% (Scores {tree_length = 39, tree_depth = 11, characters = 74, tokens = 31, subsequent_dollars = 0, initial_dollars = 0, parses = 1},156)

Thm52. If $A$ is finite, then $| \wp A | = 2 ^ {| A |}$ for all sets $A$.
%% (Scores {tree_length = 40, tree_depth = 11, characters = 73, tokens = 31, subsequent_dollars = 0, initial_dollars = 0, parses = 1},156)

Thm52. For all sets $A$, if $A$ is finite, then $| \wp A | = 2 ^ {| A |}$.
%% (Scores {tree_length = 41, tree_depth = 11, characters = 74, tokens = 32, subsequent_dollars = 0, initial_dollars = 0, parses = 1},159)

Thm52. Let $A$ be a set. Then if $A$ is finite, then $| \wp A | = 2 ^ {| A |}$.
%% (Scores {tree_length = 40, tree_depth = 10, characters = 79, tokens = 34, subsequent_dollars = 0, initial_dollars = 0, parses = 1},164)
...
%% (Scores {tree_length = 77, tree_depth = 12, characters = 143, tokens = 61, subsequent_dollars = 0, initial_dollars = 0, parses = 1},294)

Thm58. Let $A$ be a set. Let $n \in N$. Assume that $| A | = n$. Let $k \in N$. Then if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 79, tree_depth = 12, characters = 144, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},299)
...
%% (Scores {tree_length = 80, tree_depth = 13, characters = 148, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},305)

Thm58. Let $A$ be a set. Let $n \in N$. Then if $| A | = n$, then for all natural numbers $k$, if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 77, tree_depth = 12, characters = 154, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},308)
...
%% (Scores {tree_length = 75, tree_depth = 12, characters = 157, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},308)
...
%% (Scores {tree_length = 76, tree_depth = 12, characters = 158, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},310)

Thm58. Let $A$ be a set. Let $n \in N$. Assume that $| A | = n$. Then if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$ for all natural numbers $k$.
%% (Scores {tree_length = 77, tree_depth = 12, characters = 157, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},310)

Thm58. Let $A$ be a set. Let $n \in N$. Assume that $| A | = n$. Then for all natural numbers $k$, if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 78, tree_depth = 12, characters = 158, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},313)

Thm58. Let $A$ be a set. Let $n$ be a natural number. Assume that $| A | = n$. Let $k \in N$. Then if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 77, tree_depth = 12, characters = 158, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},313)
...
%% (Scores {tree_length = 75, tree_depth = 14, characters = 163, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},315)

Thm58. For all natural numbers $n$, if $| A | = n$, then for all natural numbers $k$, if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$ for all sets $A$.
%% (Scores {tree_length = 76, tree_depth = 14, characters = 162, tokens = 62, subsequent_dollars = 0, initial_dollars = 0, parses = 1},315)

Thm58. For all sets $A$, for all natural numbers $n$, if $| A | = n$, then for all natural numbers $k$, if $k \leq n$, then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 77, tree_depth = 14, characters = 163, tokens = 63, subsequent_dollars = 0, initial_dollars = 0, parses = 1},318)

Thm58. Let $A$ be a set. Let $n$ be a natural number. Assume that $| A | = n$. Let $k \in N$. Assume that $k \leq n$. Then $| \binom{ A }{ k}| = \binom{ n }{ k}$.
%% (Scores {tree_length = 78, tree_depth = 13, characters = 162, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},319)
...
%% (Scores {tree_length = 74, tree_depth = 13, characters = 168, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},320)
...
%% (Scores {tree_length = 75, tree_depth = 13, characters = 167, tokens = 64, subsequent_dollars = 0, initial_dollars = 0, parses = 1},320)
...
%% (Scores {tree_length = 75, tree_depth = 12, characters = 168, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},322)
...
%% (Scores {tree_length = 73, tree_depth = 12, characters = 171, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},322)
...
%% (Scores {tree_length = 76, tree_depth = 13, characters = 168, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},323)
...
%% (Scores {tree_length = 74, tree_depth = 12, characters = 172, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},324)
...
%% (Scores {tree_length = 75, tree_depth = 12, characters = 171, tokens = 65, subsequent_dollars = 0, initial_dollars = 0, parses = 1},324)
...
%% (Scores {tree_length = 76, tree_depth = 12, characters = 172, tokens = 66, subsequent_dollars = 0, initial_dollars = 0, parses = 1},327)
...
%% (Scores {tree_length = 75, tree_depth = 12, characters = 172, tokens = 67, subsequent_dollars = 0, initial_dollars = 0, parses = 1},327)
...
%% (Scores {tree_length = 38, tree_depth = 10, characters = 68, tokens = 25, subsequent_dollars = 0, initial_dollars = 1, parses = 1},143)

Thm78. For all vectors $u$ and $v$, $u \cdot v \leq \| u \| \| v \|$.
%% (Scores {tree_length = 39, tree_depth = 10, characters = 69, tokens = 26, subsequent_dollars = 1, initial_dollars = 0, parses = 1},146)
...
%% (Scores {tree_length = 41, tree_depth = 10, characters = 72, tokens = 28, subsequent_dollars = 0, initial_dollars = 1, parses = 1},153)

Thm91. For all vectors $u$ and $v$, $\| u + v \| \leq \| u \| + \| v \|$.
%% (Scores {tree_length = 42, tree_depth = 10, characters = 73, tokens = 29, subsequent_dollars = 1, initial_dollars = 0, parses = 1},156)
...
%% (Scores {tree_length = 66, tree_depth = 13, characters = 105, tokens = 44, subsequent_dollars = 0, initial_dollars = 0, parses = 1},229)

Thm98. Let $n \in N$. Then $n > 1$, only if $p$ is prime, $n < p$ and $p < 2 n$ for some natural number $p$.
%% (Scores {tree_length = 67, tree_depth = 13, characters = 108, tokens = 44, subsequent_dollars = 0, initial_dollars = 0, parses = 1},233)

Thm98. Let $n \in N$. Then $n > 1$, only if $p$ is prime and $n < p$ and $p < 2 n$ for a natural number $p$.
%% (Scores {tree_length = 67, tree_depth = 14, characters = 108, tokens = 44, subsequent_dollars = 0, initial_dollars = 0, parses = 1},234)

Thm98. Let $n \in N$. Then $n > 1$, only if $p$ is prime and $n < p$ and $p < 2 n$ for some natural number $p$.
%% (Scores {tree_length = 68, tree_depth = 14, characters = 111, tokens = 44, subsequent_dollars = 0, initial_dollars = 0, parses = 1},238)

Thm98. Let $n$ be a natural number. Then $n > 1$, only if $p$ is prime, $n < p$ and $p < 2 n$ for a natural number $p$.
%% (Scores {tree_length = 64, tree_depth = 13, characters = 119, tokens = 46, subsequent_dollars = 0, initial_dollars = 0, parses = 1},243)

Thm98. Let $n$ be a natural number. Then $n > 1$, only if $p$ is prime, $n < p$ and $p < 2 n$ for some natural number $p$.
%% (Scores {tree_length = 65, tree_depth = 13, characters = 122, tokens = 46, subsequent_dollars = 0, initial_dollars = 0, parses = 1},247)

Thm98. Let $n$ be a natural number. Then $n > 1$, only if $p$ is prime and $n < p$ and $p < 2 n$ for a natural number $p$.
%% (Scores {tree_length = 65, tree_depth = 14, characters = 122, tokens = 46, subsequent_dollars = 0, initial_dollars = 0, parses = 1},248)

Thm98. Let $n$ be a natural number. Then $n > 1$, only if $p$ is prime and $n < p$ and $p < 2 n$ for some natural number $p$.
%% (Scores {tree_length = 66, tree_depth = 14, characters = 125, tokens = 46, subsequent_dollars = 0, initial_dollars = 0, parses = 1},252)

Thm98. Let $n \in N$. Then if $n > 1$, then there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$.
%% (Scores {tree_length = 68, tree_depth = 13, characters = 125, tokens = 48, subsequent_dollars = 0, initial_dollars = 0, parses = 1},255)
...
%% (Scores {tree_length = 65, tree_depth = 14, characters = 134, tokens = 47, subsequent_dollars = 0, initial_dollars = 0, parses = 1},261)

Thm98. If $n > 1$, then there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$ for all natural numbers $n$.
%% (Scores {tree_length = 66, tree_depth = 14, characters = 133, tokens = 47, subsequent_dollars = 0, initial_dollars = 0, parses = 1},261)

Thm98. $n > 1$, only if there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$ for every natural number $n$.
%% (Scores {tree_length = 65, tree_depth = 14, characters = 134, tokens = 47, subsequent_dollars = 0, initial_dollars = 1, parses = 1},262)

Thm98. $n > 1$, only if there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$ for all natural numbers $n$.
%% (Scores {tree_length = 66, tree_depth = 14, characters = 133, tokens = 47, subsequent_dollars = 0, initial_dollars = 1, parses = 1},262)

Thm98. For all natural numbers $n$, if $n > 1$, then there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$.
%% (Scores {tree_length = 67, tree_depth = 14, characters = 134, tokens = 48, subsequent_dollars = 0, initial_dollars = 0, parses = 1},264)

Thm98. For all natural numbers $n$, $n > 1$, only if there exists a natural number $p$, such that $p$ is prime, $n < p$ and $p < 2 n$.
%% (Scores {tree_length = 67, tree_depth = 14, characters = 134, tokens = 48, subsequent_dollars = 1, initial_dollars = 0, parses = 1},265)
...
%% (Scores {tree_length = 66, tree_depth = 13, characters = 139, tokens = 50, subsequent_dollars = 0, initial_dollars = 0, parses = 1},269)
